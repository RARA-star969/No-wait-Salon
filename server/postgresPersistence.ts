...
const tables:Record<string,string[]>={
  ...
  salon_staff:['id','salon_id','name','photo_url','role','service_ids_json','working_status','active','sort_order','created_at','updated_at','rating','review_count','experience_years','bio','specialties_json'],
