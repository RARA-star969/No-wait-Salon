    ...
    <div className="fixed inset-0 z-[110] flex items-end justify-center bg-slate-950/55 sm:items-center">
      ...
      >
        <div className="flex items-start justify-between gap-3 px-5 pt-5">
          ...
          <button id="close-price-breakdown-btn" type="button" onClick={onClose} aria-label="Close" className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-white text-[#42524F] ring-1 ring-[#E2EAE9]">
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="mt-4 min-h-0 flex-1 overflow-y-auto px-5">
          ...
          <section className="mt-4 rounded-2xl border border-[#E1E7E6] bg-white p-4">
            <h3 className="text-xs font-bold text-[#17201F]">Apply Coupon</h3>
