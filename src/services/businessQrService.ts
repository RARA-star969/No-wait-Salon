...
export const businessQrService={
  ...
  leaveQueue:(salonId:string,sessionId:string)=>request<any>(`/api/salons/${encodeURIComponent(salonId)}/commands`,{method:'POST',body:JSON.stringify({type:'cancel_customer',sessionId})}),
